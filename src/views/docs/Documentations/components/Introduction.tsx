            ...
            <div id="coreLibrary">
                ...
                <ul>
                    <li>
                        ...
                        <p className="mt-0">
                            A popular JavaScript library for building user
                            interfaces.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p className="mt-0">
                            Vite is a modern, blazing-fast tool for scaffolding
                            and bundling
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p className="mt-0">
                            Redux Toolkit is package that help to write
                            Redux(State management tool) logic.{' '}
                        </p>
                    </li>
                </ul>
            </div>
